...
### World Values Survey — 39 das 48 perguntas · categoria A
...
**1. A redação em português é minha, não a oficial brasileira.**
...
**2. Mudei o formato dos itens, e isso tem custo.**
...
menção em lista (Q17). Aqui tudo virou uma escala única de concordância de 5 pontos. A derivação é
rastreável, mas **o resultado não é o instrumento original e não herda automaticamente a validação
dele**.

**3. Cada pergunta carrega um eixo só.**
...
**4. Onde fica o zero é decisão normativa, não fato.**
...
**5. Ainda não há validação empírica.**
